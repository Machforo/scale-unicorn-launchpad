    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-12 pt-24">
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Real Estate</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            PropTech solutions and real estate strategies for sustainable growth.
          </p>
        </header>
        ...
        <section className="bg-card border border-border rounded-lg p-6 shadow-card mb-12">
          ...
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li>Investment analytics tools</li>
