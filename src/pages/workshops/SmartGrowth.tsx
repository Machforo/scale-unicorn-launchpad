...
const SmartGrowth = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PaymentModal isOpen={showPayment} onClose={() => setShowPayment(false)} workshopTitle="Smart Growth Without Diluting Equity" servicePriceINR={25000} servicePriceUSD={300} />
    </div>
  );
};
